<%	
		...
		Dim vReferers: vReferers = Array("www.axismedical.co.uk","axismedical.widagroup.net","axismedical")
		
		'Example Recipients 
		'Dim vRecipients: vRecipients = Array("defabs.inty.net")
		Dim vRecipients: vRecipients = Array("axismedical.co.uk","widagroup.com")
